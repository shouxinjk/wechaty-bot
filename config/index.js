...
export default {
    ...
    groupingDuration:3*60*60*1000,//连续发送通知的间隔时间
    // 房间/群聊
    room: {
    ...
    //推荐时的广告语
    tips:[
        "碎片时间阅读，效果更好。每小时可以阅读20篇，每天可以多次进入，慢慢效果就上来了~~",
        "对等阅读，不需要爬楼艾特逐个回复，节省时间输出好内容",
        "列表按照阅豆多少排序，阅豆越多越靠前，阅豆小于0会暂时不显示，小于0就表示自己被阅读的次数比阅读别人的次数多，要赶紧回阅哦~~",
        "也可以在群里发起互阅，输入：互阅开车 就可以哦~~",
        "每篇要求阅读保持10秒阅并报数，每小时阅读20篇，有时间就可以进入读几篇的哦~~",
        "在阅读文章后还可以申请转载，申请后对方会立即收到通知，对方开白后也会立即发送通知，非常方便的哈",
        "文章发表后也要同步进入列表让更多人看到哦~~",
        "阅读和被阅读都通过阅豆统计，阅读一次奖励2阅豆，被阅读一次消耗2阅豆，对等阅读更轻松",
        "邀请加入还有阅豆奖励哦，每邀请一次奖励20阅豆",
        "每天阅读超过50篇也会额外奖励阅豆哦~~",
        "开白互推效果更好：为了让好文章让更多人看到，支持号主申请转载，转载文章带有公众号卡片，能够互推吸粉哦~~",
        "文章发进列表阅读更方便：仅支持公众号文章，其他文章不支持哦，发布的时候会提示的",
        "用阅豆保证对等阅读：每次阅读奖励2阅豆，被阅读消耗2阅豆；每次关注奖励5阅豆，被关注消耗5阅豆",
        "回粉回阅更方便：可以进入数据查看阅我和粉我数据，优先回阅回粉哦~~",
        "不开流量主也可以内容带货：系统有带货功能，提供有图文物料，进入后会转换为自己专属的链接或二维码，能够在文章嵌入，让粉丝所读即所得，下单就会有佣金收入的哦~~",
        "邀请加入可以奖励阅豆：能够邀请公众号主加入，每邀请一次奖励20阅豆，同时也将享有更多带货佣金收益"
    ],
}
